    ...
    <div class="col-md-3">
        <div class="box">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="<?php echo base_url(); ?>/index.php/demo_controller"><i class="fa fa-home"></i> My Home</a></li>
                <li><a href="#"><i class="fa fa-calendar"></i> Clinic Roster</a></li>
                <li><a href="<?php echo base_url(); ?>/index.php/demo_controller/registerpatient"><i class="fa fa-stethoscope"></i> Register Patient</a></li>
