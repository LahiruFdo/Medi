...
<body>
    ...
    <div class="col-md-6" align="center">
        <div class="box">
                    ...
                    <form action="<?php echo site_url('demo_controller/submit_data'); ?>" method="post">
                            ...
                            <table>
                                    <h3>Patient's Personal Details</h3>
                                            ...
                                            <tr>
                                                <td>Name:</td>
                                                <td><input type="text" name="patient_name" required class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Gender:</td>
                                            ...
                                            <tr>
                                                <td>Address:</td>
                                                <td><input type="text" name="address" required class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Telephone No:</td>
                                                <td><input type="text" name="telephone_no" maxlength="10" class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Mobile No:</td>
                                                <td><input type="text" name="mobile_no" maxlength="10" class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Date of Birth:</td>
                                                <td><input type="date" name="dob" required class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>District:</td>
                                                <td><input type="text" name="district" required class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>No of Siblings:</td>
                                                <td><input type="text" name="siblings" class="in"></td>
                                            </tr>
                                            
                                            <tr>
                                                <td>Father's Occupation:</td>
                                                <td><input type="text" name="f_occupation" class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Mother's Occupation:</td>
                                                <td><input type="text" name="m_occupation" class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Monthly Income:</td>
                                                <td><input type="text" name="income" class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Name of the Guardian:</td>
                                                <td><input type="text" name="guardian" required class="in"></td>
                                            </tr>
                                            <tr>
                                                <td>Current Diagnosis:</td>
                                                <td><input type="text" name="diagnosis" required class="in"></td>
                                            </tr>
                                            
                                            <tr>
                                                <td>Bed Id:</td>
                                                <td><input type="text" name="bed_id" required class="in"></td>
                                            </tr>
                                            <tr></tr>
                                            <tr></tr>
                                            <tr></tr>
                                            <tr></tr>
                                            <tr>
                                                <td colspan="2" align="right"><a href="<?php echo base_url(); ?>/index.php/demo_controller/viewpatient" class="but1">Pateint Search</a><button type="submit" class="but">Register Patient</button></td>
                                            </tr>
                            </table>
